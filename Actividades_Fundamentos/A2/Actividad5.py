...
gradosF = float(input("Indica un valor en grados Fahrenherit: ")) #float representa datos positivos y negativos decimales


gradosC = (gradosF - 32) * (5/9)

#Calculos de conversion V2
...
print("La conversion a grados celsius es: " + str(gradosC) + "")
